...
entity resnet50_1_outbuf_V_ram is 
    generic(
...
architecture rtl of resnet50_1_outbuf_V_ram is 
...
architecture arch of resnet50_1_outbuf_V is
    component resnet50_1_outbuf_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    resnet50_1_outbuf_V_ram_U :  component resnet50_1_outbuf_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
