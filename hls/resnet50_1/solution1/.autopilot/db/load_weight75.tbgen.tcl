...
set C_modelArgList {
	...
	{ P int 1 regular  }
	{ K int 2 regular  }
	{ l_0_out int 13 regular {fifo 1}  }
	{ OSIZE_out int 6 regular {fifo 1}  }
	{ TO_out int 5 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ddr_V", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "l_0_out", "interface" : "fifo", "bitwidth" : 13, "direction" : "WRITEONLY"} , 
 	{ "Name" : "OSIZE_out", "interface" : "fifo", "bitwidth" : 6, "direction" : "WRITEONLY"} , 
 	{ "Name" : "TO_out", "interface" : "fifo", "bitwidth" : 5, "direction" : "WRITEONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "l_0_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":13, "type": "signal", "bundle":{"name": "l_0_out", "role": "din" }} , 
 	...
 	{ "name": "OSIZE_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "OSIZE_out", "role": "din" }} , 
 	...
 	{ "name": "TO_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "TO_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	l_0 { ap_none {  { l_0 in_data 0 13 } } }
	OFFSET { ap_none {  { OFFSET in_data 0 22 } } }
	...
	l_0_out { ap_fifo {  { l_0_out_din fifo_data 1 13 }  { l_0_out_full_n fifo_status 0 1 }  { l_0_out_write fifo_update 1 1 } } }
	OSIZE_out { ap_fifo {  { OSIZE_out_din fifo_data 1 6 }  { OSIZE_out_full_n fifo_status 0 1 }  { OSIZE_out_write fifo_update 1 1 } } }
	TO_out { ap_fifo {  { TO_out_din fifo_data 1 5 }  { TO_out_full_n fifo_status 0 1 }  { TO_out_write fifo_update 1 1 } } }
