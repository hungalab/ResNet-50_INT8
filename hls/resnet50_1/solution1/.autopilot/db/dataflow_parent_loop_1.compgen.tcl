...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outbuf_V_4 \
    op interface \
    ports { outbuf_V_4_address0 { O 14 vector } outbuf_V_4_ce0 { O 1 bit } outbuf_V_4_d0 { O 1536 vector } outbuf_V_4_q0 { I 1536 vector } outbuf_V_4_we0 { O 1 bit } outbuf_V_4_address1 { O 14 vector } outbuf_V_4_ce1 { O 1 bit } outbuf_V_4_d1 { O 1536 vector } outbuf_V_4_q1 { I 1536 vector } outbuf_V_4_we1 { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln204_2 \
    op interface \
    ports { mul_ln204_2 { I 21 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_OFFSET \
    op interface \
    ports { OFFSET { I 22 vector } OFFSET_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_OSIZE \
    op interface \
    ports { OSIZE { I 6 vector } OSIZE_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_TO_r \
    op interface \
    ports { TO_r { I 5 vector } TO_r_ap_vld { I 1 bit } } \
} "
}
