...
struct dataflow_parent_loop_1 : public sc_module {
    ...
    sc_signal< sc_lv<13> > dataflow_in_loop_Con_U0_l_0;
    ...
    sc_signal< sc_lv<14> > dataflow_in_loop_Con_U0_outbuf_V_4_address0;
    ...
    sc_signal< sc_lv<14> > dataflow_in_loop_Con_U0_outbuf_V_4_address1;
    ...
    sc_signal< sc_lv<21> > loop_dataflow_input_count;
    sc_signal< sc_lv<21> > loop_dataflow_output_count;
    sc_signal< sc_lv<21> > bound_minus_1;
