...
const sc_lv<17> dataflow_parent_loop_1::ap_const_lv17_0 = "00000000000000000";
const sc_lv<17> dataflow_parent_loop_1::ap_const_lv17_1 = "1";
...
dataflow_parent_loop_1::dataflow_parent_loop_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    dataflow_in_loop_Con_U0->outbuf_V_address0(dataflow_in_loop_Con_U0_outbuf_V_address0);
    dataflow_in_loop_Con_U0->outbuf_V_ce0(dataflow_in_loop_Con_U0_outbuf_V_ce0);
    dataflow_in_loop_Con_U0->outbuf_V_d0(dataflow_in_loop_Con_U0_outbuf_V_d0);
    dataflow_in_loop_Con_U0->outbuf_V_q0(outbuf_V_q0);
    dataflow_in_loop_Con_U0->outbuf_V_we0(dataflow_in_loop_Con_U0_outbuf_V_we0);
    dataflow_in_loop_Con_U0->outbuf_V_address1(dataflow_in_loop_Con_U0_outbuf_V_address1);
    dataflow_in_loop_Con_U0->outbuf_V_ce1(dataflow_in_loop_Con_U0_outbuf_V_ce1);
    dataflow_in_loop_Con_U0->outbuf_V_d1(dataflow_in_loop_Con_U0_outbuf_V_d1);
    dataflow_in_loop_Con_U0->outbuf_V_q1(ap_var_for_const4);
    dataflow_in_loop_Con_U0->outbuf_V_we1(dataflow_in_loop_Con_U0_outbuf_V_we1);
    ...
    sensitive << ( dataflow_in_loop_Con_U0_outbuf_V_address0 );

    SC_METHOD(thread_outbuf_V_address1);
    sensitive << ( dataflow_in_loop_Con_U0_outbuf_V_address1 );

    SC_METHOD(thread_outbuf_V_ce0);
    sensitive << ( dataflow_in_loop_Con_U0_outbuf_V_ce0 );

    SC_METHOD(thread_outbuf_V_ce1);
    sensitive << ( dataflow_in_loop_Con_U0_outbuf_V_ce1 );

    SC_METHOD(thread_outbuf_V_d0);

    SC_METHOD(thread_outbuf_V_d1);
    sensitive << ( dataflow_in_loop_Con_U0_outbuf_V_d1 );

    SC_METHOD(thread_outbuf_V_we0);

    SC_METHOD(thread_outbuf_V_we1);
    sensitive << ( dataflow_in_loop_Con_U0_outbuf_V_we1 );
    ...
    sc_trace(mVcdFile, mul_ln189_2, "(port)mul_ln189_2");
    ...
    sc_trace(mVcdFile, outbuf_V_address0, "(port)outbuf_V_address0");
    sc_trace(mVcdFile, outbuf_V_ce0, "(port)outbuf_V_ce0");
    sc_trace(mVcdFile, outbuf_V_d0, "(port)outbuf_V_d0");
    sc_trace(mVcdFile, outbuf_V_q0, "(port)outbuf_V_q0");
    sc_trace(mVcdFile, outbuf_V_we0, "(port)outbuf_V_we0");
    sc_trace(mVcdFile, outbuf_V_address1, "(port)outbuf_V_address1");
    sc_trace(mVcdFile, outbuf_V_ce1, "(port)outbuf_V_ce1");
    sc_trace(mVcdFile, outbuf_V_d1, "(port)outbuf_V_d1");
    sc_trace(mVcdFile, outbuf_V_q1, "(port)outbuf_V_q1");
    sc_trace(mVcdFile, outbuf_V_we1, "(port)outbuf_V_we1");
    ...
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_address0, "dataflow_in_loop_Con_U0_outbuf_V_address0");
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_ce0, "dataflow_in_loop_Con_U0_outbuf_V_ce0");
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_d0, "dataflow_in_loop_Con_U0_outbuf_V_d0");
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_we0, "dataflow_in_loop_Con_U0_outbuf_V_we0");
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_address1, "dataflow_in_loop_Con_U0_outbuf_V_address1");
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_ce1, "dataflow_in_loop_Con_U0_outbuf_V_ce1");
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_d1, "dataflow_in_loop_Con_U0_outbuf_V_d1");
    sc_trace(mVcdFile, dataflow_in_loop_Con_U0_outbuf_V_we1, "dataflow_in_loop_Con_U0_outbuf_V_we1");
...
void dataflow_parent_loop_1::thread_bound_minus_1() {
    bound_minus_1 = (!mul_ln189_2.read().is_01() || !ap_const_lv17_1.is_01())? sc_lv<17>(): (sc_biguint<17>(mul_ln189_2.read()) - sc_biguint<17>(ap_const_lv17_1));
}
...
void dataflow_parent_loop_1::thread_dataflow_in_loop_Con_U0_l_0() {
    dataflow_in_loop_Con_U0_l_0 =  (sc_lv<9>) (loop_dataflow_input_count.read());
}
...
void dataflow_parent_loop_1::thread_outbuf_V_address0() {
    outbuf_V_address0 = dataflow_in_loop_Con_U0_outbuf_V_address0.read();
}

void dataflow_parent_loop_1::thread_outbuf_V_address1() {
    outbuf_V_address1 = dataflow_in_loop_Con_U0_outbuf_V_address1.read();
}

void dataflow_parent_loop_1::thread_outbuf_V_ce0() {
    outbuf_V_ce0 = dataflow_in_loop_Con_U0_outbuf_V_ce0.read();
}

void dataflow_parent_loop_1::thread_outbuf_V_ce1() {
    outbuf_V_ce1 = dataflow_in_loop_Con_U0_outbuf_V_ce1.read();
}

void dataflow_parent_loop_1::thread_outbuf_V_d0() {
    outbuf_V_d0 = ap_const_lv1536_lc_1;
}

void dataflow_parent_loop_1::thread_outbuf_V_d1() {
    outbuf_V_d1 = dataflow_in_loop_Con_U0_outbuf_V_d1.read();
}

void dataflow_parent_loop_1::thread_outbuf_V_we0() {
    outbuf_V_we0 = ap_const_logic_0;
}

void dataflow_parent_loop_1::thread_outbuf_V_we1() {
    outbuf_V_we1 = dataflow_in_loop_Con_U0_outbuf_V_we1.read();
}
