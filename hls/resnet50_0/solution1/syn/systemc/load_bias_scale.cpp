...
const sc_lv<3> load_bias_scale::ap_const_lv3_1 = "1";
...
load_bias_scale::load_bias_scale(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_add_ln70_fu_183_p2);
    sensitive << ( offset );
    sensitive << ( zext_ln75_1_fu_179_p1 );

    SC_METHOD(thread_add_ln85_1_fu_267_p2);
    sensitive << ( add_ln85_reg_421 );
    sensitive << ( zext_ln90_1_fu_263_p1 );

    SC_METHOD(thread_add_ln85_fu_235_p2);
    sensitive << ( offset );
    sensitive << ( zext_ln85_fu_231_p1 );
    ...
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_enable_reg_pp0_iter1 );
    sensitive << ( icmp_ln65_reg_321_pp0_iter1_reg );
    ...
    sensitive << ( ap_enable_reg_pp1_iter0 );
    sensitive << ( ap_enable_reg_pp1_iter1 );
    sensitive << ( icmp_ln80_reg_426_pp1_iter1_reg );
    ...
    sensitive << ( icmp_ln65_fu_156_p2 );

    SC_METHOD(thread_ap_condition_pp1_exit_iter0_state28);
    sensitive << ( icmp_ln80_fu_240_p2 );
    ...
    SC_METHOD(thread_icmp_ln65_fu_156_p2);
    sensitive << ( TO_r );
    sensitive << ( ap_enable_reg_pp0_iter0 );
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    ...
    SC_METHOD(thread_icmp_ln80_fu_240_p2);
    sensitive << ( TO_r );
    sensitive << ( ap_enable_reg_pp1_iter0 );
    sensitive << ( ap_CS_fsm_pp1_stage0 );
    ...
    sensitive << ( zext_ln70_fu_188_p1 );
    sensitive << ( zext_ln85_1_fu_272_p1 );
    ...
    SC_METHOD(thread_shl_ln5_fu_171_p3);
    sensitive << ( trunc_ln70_fu_167_p1 );

    SC_METHOD(thread_shl_ln85_1_fu_255_p3);
    sensitive << ( trunc_ln85_fu_251_p1 );

    SC_METHOD(thread_shl_ln_fu_224_p3);
    sensitive << ( TO_r );

    SC_METHOD(thread_trunc_ln70_fu_167_p1);
    sensitive << ( ap_phi_mux_i_0_phi_fu_136_p4 );

    SC_METHOD(thread_trunc_ln85_fu_251_p1);
    sensitive << ( ap_phi_mux_i1_0_phi_fu_148_p4 );

    SC_METHOD(thread_zext_ln70_fu_188_p1);
    sensitive << ( add_ln70_reg_330 );

    SC_METHOD(thread_zext_ln75_1_fu_179_p1);
    sensitive << ( shl_ln5_fu_171_p3 );

    SC_METHOD(thread_zext_ln75_fu_198_p1);
    sensitive << ( i_0_reg_132_pp0_iter1_reg );

    SC_METHOD(thread_zext_ln85_1_fu_272_p1);
    sensitive << ( add_ln85_1_reg_435 );

    SC_METHOD(thread_zext_ln85_fu_231_p1);
    sensitive << ( shl_ln_fu_224_p3 );

    SC_METHOD(thread_zext_ln90_1_fu_263_p1);
    sensitive << ( shl_ln85_1_fu_255_p3 );
    ...
    sc_trace(mVcdFile, icmp_ln65_reg_321, "icmp_ln65_reg_321");
    ...
    sc_trace(mVcdFile, icmp_ln65_reg_321_pp0_iter1_reg, "icmp_ln65_reg_321_pp0_iter1_reg");
    ...
    sc_trace(mVcdFile, icmp_ln80_reg_426, "icmp_ln80_reg_426");
    ...
    sc_trace(mVcdFile, icmp_ln80_reg_426_pp1_iter1_reg, "icmp_ln80_reg_426_pp1_iter1_reg");
    ...
    sc_trace(mVcdFile, icmp_ln65_fu_156_p2, "icmp_ln65_fu_156_p2");
    sc_trace(mVcdFile, i_fu_161_p2, "i_fu_161_p2");
    sc_trace(mVcdFile, i_reg_325, "i_reg_325");
    sc_trace(mVcdFile, add_ln70_fu_183_p2, "add_ln70_fu_183_p2");
    sc_trace(mVcdFile, add_ln70_reg_330, "add_ln70_reg_330");
    ...
    sc_trace(mVcdFile, add_ln85_fu_235_p2, "add_ln85_fu_235_p2");
    sc_trace(mVcdFile, add_ln85_reg_421, "add_ln85_reg_421");
    sc_trace(mVcdFile, ap_CS_fsm_state27, "ap_CS_fsm_state27");
    sc_trace(mVcdFile, icmp_ln80_fu_240_p2, "icmp_ln80_fu_240_p2");
    sc_trace(mVcdFile, i_1_fu_245_p2, "i_1_fu_245_p2");
    sc_trace(mVcdFile, i_1_reg_430, "i_1_reg_430");
    sc_trace(mVcdFile, add_ln85_1_fu_267_p2, "add_ln85_1_fu_267_p2");
    sc_trace(mVcdFile, add_ln85_1_reg_435, "add_ln85_1_reg_435");
    ...
    sc_trace(mVcdFile, zext_ln75_fu_198_p1, "zext_ln75_fu_198_p1");
    sc_trace(mVcdFile, zext_ln90_fu_282_p1, "zext_ln90_fu_282_p1");
    sc_trace(mVcdFile, zext_ln70_fu_188_p1, "zext_ln70_fu_188_p1");
    sc_trace(mVcdFile, zext_ln85_1_fu_272_p1, "zext_ln85_1_fu_272_p1");
    sc_trace(mVcdFile, trunc_ln70_fu_167_p1, "trunc_ln70_fu_167_p1");
    sc_trace(mVcdFile, shl_ln5_fu_171_p3, "shl_ln5_fu_171_p3");
    sc_trace(mVcdFile, zext_ln75_1_fu_179_p1, "zext_ln75_1_fu_179_p1");
    sc_trace(mVcdFile, shl_ln_fu_224_p3, "shl_ln_fu_224_p3");
    sc_trace(mVcdFile, zext_ln85_fu_231_p1, "zext_ln85_fu_231_p1");
    sc_trace(mVcdFile, trunc_ln85_fu_251_p1, "trunc_ln85_fu_251_p1");
    sc_trace(mVcdFile, shl_ln85_1_fu_255_p3, "shl_ln85_1_fu_255_p3");
    sc_trace(mVcdFile, zext_ln90_1_fu_263_p1, "zext_ln90_1_fu_263_p1");
...
void load_bias_scale::thread_ap_clk_no_reset_() {
    ...
    } else if ((esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
                esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        i1_0_reg_144 = i_1_reg_430.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && 
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_fu_156_p2.read()))) {
        add_ln70_reg_330 = add_ln70_fu_183_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_fu_240_p2.read()))) {
        add_ln85_1_reg_435 = add_ln85_1_fu_267_p2.read();
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state27.read())) {
        add_ln85_reg_421 = add_ln85_fu_235_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage2.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage2_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_10_reg_496 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage3.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage3_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_11_reg_501 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage4.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage4_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_12_reg_506 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage5.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage5_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_13_reg_511 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage6.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage6_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_14_reg_516 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage7.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage7_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_15_reg_521 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage9.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage9_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_1_reg_451 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage10.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage10_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_2_reg_456 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage11.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage11_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_3_reg_461 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage12.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage12_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_4_reg_466 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage13.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage13_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_5_reg_471 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage14.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage14_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_6_reg_476 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage15.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage15_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_7_reg_481 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_8_reg_486 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage1.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage1_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_9_reg_491 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage8.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage8_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_1_read_reg_446 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage9.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage9_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_128_reg_346 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage10.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage10_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_129_reg_351 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage11.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage11_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_130_reg_356 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage12.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage12_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_131_reg_361 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage13.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage13_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_132_reg_366 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage14.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage14_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_133_reg_371 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage15.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage15_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_134_reg_376 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_135_reg_381 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage1_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_136_reg_386 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage2.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage2_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_137_reg_391 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage3.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage3_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_138_reg_396 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage4.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage4_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_139_reg_401 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage5.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage5_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_140_reg_406 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage6.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage6_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_141_reg_411 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage7.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage7_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_142_reg_416 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage8.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage8_11001.read(), ap_const_boolean_0))) {
        ddr_V_addr_read_reg_341 = m_axi_ddr_V_RDATA.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        i1_0_reg_144_pp1_iter1_reg = i1_0_reg_144.read();
        icmp_ln80_reg_426 = icmp_ln80_fu_240_p2.read();
        icmp_ln80_reg_426_pp1_iter1_reg = icmp_ln80_reg_426.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        i_0_reg_132_pp0_iter1_reg = i_0_reg_132.read();
        icmp_ln65_reg_321 = icmp_ln65_fu_156_p2.read();
        icmp_ln65_reg_321_pp0_iter1_reg = icmp_ln65_reg_321.read();
    }
...
void load_bias_scale::thread_add_ln70_fu_183_p2() {
    add_ln70_fu_183_p2 = (!offset.read().is_01() || !zext_ln75_1_fu_179_p1.read().is_01())? sc_lv<16>(): (sc_biguint<16>(offset.read()) + sc_biguint<16>(zext_ln75_1_fu_179_p1.read()));
}

void load_bias_scale::thread_add_ln85_1_fu_267_p2() {
    add_ln85_1_fu_267_p2 = (!zext_ln90_1_fu_263_p1.read().is_01() || !add_ln85_reg_421.read().is_01())? sc_lv<16>(): (sc_biguint<16>(zext_ln90_1_fu_263_p1.read()) + sc_biguint<16>(add_ln85_reg_421.read()));
}

void load_bias_scale::thread_add_ln85_fu_235_p2() {
    add_ln85_fu_235_p2 = (!offset.read().is_01() || !zext_ln85_fu_231_p1.read().is_01())? sc_lv<16>(): (sc_biguint<16>(offset.read()) + sc_biguint<16>(zext_ln85_fu_231_p1.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage0_11001() {
    ap_block_pp0_stage0_11001 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage0_subdone() {
    ap_block_pp0_stage0_subdone = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage10_11001() {
    ap_block_pp0_stage10_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage10_subdone() {
    ap_block_pp0_stage10_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage11_11001() {
    ap_block_pp0_stage11_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage11_subdone() {
    ap_block_pp0_stage11_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage12_11001() {
    ap_block_pp0_stage12_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage12_subdone() {
    ap_block_pp0_stage12_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage13_11001() {
    ap_block_pp0_stage13_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage13_subdone() {
    ap_block_pp0_stage13_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage14_11001() {
    ap_block_pp0_stage14_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage14_subdone() {
    ap_block_pp0_stage14_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage15_11001() {
    ap_block_pp0_stage15_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage15_subdone() {
    ap_block_pp0_stage15_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage1_11001() {
  ...
  esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && 
...
void load_bias_scale::thread_ap_block_pp0_stage2_11001() {
    ap_block_pp0_stage2_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage2_subdone() {
    ap_block_pp0_stage2_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage3_11001() {
    ap_block_pp0_stage3_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage3_subdone() {
    ap_block_pp0_stage3_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage4_11001() {
    ap_block_pp0_stage4_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage4_subdone() {
    ap_block_pp0_stage4_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage5_11001() {
    ap_block_pp0_stage5_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage5_subdone() {
    ap_block_pp0_stage5_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage6_11001() {
    ap_block_pp0_stage6_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage6_subdone() {
    ap_block_pp0_stage6_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage7_11001() {
    ap_block_pp0_stage7_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage7_subdone() {
    ap_block_pp0_stage7_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage8_11001() {
    ap_block_pp0_stage8_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage8_subdone() {
    ap_block_pp0_stage8_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp0_stage9_11001() {
    ap_block_pp0_stage9_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp0_stage9_subdone() {
    ap_block_pp0_stage9_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage0_11001() {
    ap_block_pp1_stage0_11001 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage0_subdone() {
    ap_block_pp1_stage0_subdone = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage10_11001() {
    ap_block_pp1_stage10_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage10_subdone() {
    ap_block_pp1_stage10_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage11_11001() {
    ap_block_pp1_stage11_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage11_subdone() {
    ap_block_pp1_stage11_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage12_11001() {
    ap_block_pp1_stage12_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage12_subdone() {
    ap_block_pp1_stage12_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage13_11001() {
    ap_block_pp1_stage13_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage13_subdone() {
    ap_block_pp1_stage13_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage14_11001() {
    ap_block_pp1_stage14_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage14_subdone() {
    ap_block_pp1_stage14_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage15_11001() {
    ap_block_pp1_stage15_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage15_subdone() {
    ap_block_pp1_stage15_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage1_11001() {
  ...
  esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read())));
}
...
void load_bias_scale::thread_ap_block_pp1_stage2_11001() {
    ap_block_pp1_stage2_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage2_subdone() {
    ap_block_pp1_stage2_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage3_11001() {
    ap_block_pp1_stage3_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage3_subdone() {
    ap_block_pp1_stage3_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage4_11001() {
    ap_block_pp1_stage4_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage4_subdone() {
    ap_block_pp1_stage4_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage5_11001() {
    ap_block_pp1_stage5_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage5_subdone() {
    ap_block_pp1_stage5_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage6_11001() {
    ap_block_pp1_stage6_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage6_subdone() {
    ap_block_pp1_stage6_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage7_11001() {
    ap_block_pp1_stage7_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage7_subdone() {
    ap_block_pp1_stage7_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage8_11001() {
    ap_block_pp1_stage8_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage8_subdone() {
    ap_block_pp1_stage8_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_pp1_stage9_11001() {
    ap_block_pp1_stage9_11001 = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_pp1_stage9_subdone() {
    ap_block_pp1_stage9_subdone = (esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state10_pp0_stage8_iter0() {
    ap_block_state10_pp0_stage8_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state11_pp0_stage9_iter0() {
    ap_block_state11_pp0_stage9_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state12_pp0_stage10_iter0() {
    ap_block_state12_pp0_stage10_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state13_pp0_stage11_iter0() {
    ap_block_state13_pp0_stage11_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state14_pp0_stage12_iter0() {
    ap_block_state14_pp0_stage12_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state15_pp0_stage13_iter0() {
    ap_block_state15_pp0_stage13_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state16_pp0_stage14_iter0() {
    ap_block_state16_pp0_stage14_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state17_pp0_stage15_iter0() {
    ap_block_state17_pp0_stage15_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state18_pp0_stage0_iter1() {
    ap_block_state18_pp0_stage0_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state19_pp0_stage1_iter1() {
    ap_block_state19_pp0_stage1_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state20_pp0_stage2_iter1() {
    ap_block_state20_pp0_stage2_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state21_pp0_stage3_iter1() {
    ap_block_state21_pp0_stage3_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state22_pp0_stage4_iter1() {
    ap_block_state22_pp0_stage4_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state23_pp0_stage5_iter1() {
    ap_block_state23_pp0_stage5_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state24_pp0_stage6_iter1() {
    ap_block_state24_pp0_stage6_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state25_pp0_stage7_iter1() {
    ap_block_state25_pp0_stage7_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321_pp0_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_state29_io() {
    ap_block_state29_io = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_ARREADY.read()));
}
...
void load_bias_scale::thread_ap_block_state36_pp1_stage8_iter0() {
    ap_block_state36_pp1_stage8_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state37_pp1_stage9_iter0() {
    ap_block_state37_pp1_stage9_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state38_pp1_stage10_iter0() {
    ap_block_state38_pp1_stage10_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state39_pp1_stage11_iter0() {
    ap_block_state39_pp1_stage11_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state3_io() {
    ap_block_state3_io = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_ARREADY.read()));
}
...
void load_bias_scale::thread_ap_block_state40_pp1_stage12_iter0() {
    ap_block_state40_pp1_stage12_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state41_pp1_stage13_iter0() {
    ap_block_state41_pp1_stage13_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state42_pp1_stage14_iter0() {
    ap_block_state42_pp1_stage14_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state43_pp1_stage15_iter0() {
    ap_block_state43_pp1_stage15_iter0 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state44_pp1_stage0_iter1() {
    ap_block_state44_pp1_stage0_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state45_pp1_stage1_iter1() {
    ap_block_state45_pp1_stage1_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state46_pp1_stage2_iter1() {
    ap_block_state46_pp1_stage2_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state47_pp1_stage3_iter1() {
    ap_block_state47_pp1_stage3_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state48_pp1_stage4_iter1() {
    ap_block_state48_pp1_stage4_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state49_pp1_stage5_iter1() {
    ap_block_state49_pp1_stage5_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_block_state50_pp1_stage6_iter1() {
    ap_block_state50_pp1_stage6_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}

void load_bias_scale::thread_ap_block_state51_pp1_stage7_iter1() {
    ap_block_state51_pp1_stage7_iter1 = (esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426_pp1_iter1_reg.read()) && esl_seteq<1,1,1>(ap_const_logic_0, m_axi_ddr_V_RVALID.read()));
}
...
void load_bias_scale::thread_ap_condition_pp0_exit_iter0_state2() {
    if (esl_seteq<1,1,1>(icmp_ln65_fu_156_p2.read(), ap_const_lv1_1)) {
...
void load_bias_scale::thread_ap_condition_pp1_exit_iter0_state28() {
    if (esl_seteq<1,1,1>(icmp_ln80_fu_240_p2.read(), ap_const_lv1_1)) {
...
void load_bias_scale::thread_ap_phi_mux_i1_0_phi_fu_148_p4() {
    if ((esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && 
         esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter1.read()) && 
...
void load_bias_scale::thread_bias_address0() {
    bias_address0 =  (sc_lv<2>) (zext_ln75_fu_198_p1.read());
}
...
void load_bias_scale::thread_ddr_V_blk_n_AR() {
    if (((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
          ...
          esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read())) || 
         (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage1.read()) && 
          esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && 
          esl_seteq<1,1,1>(ap_block_pp1_stage1.read(), ap_const_boolean_0) && 
          esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln80_reg_426.read())))) {
...
void load_bias_scale::thread_i_1_fu_245_p2() {
    i_1_fu_245_p2 = (!ap_phi_mux_i1_0_phi_fu_148_p4.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(ap_phi_mux_i1_0_phi_fu_148_p4.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void load_bias_scale::thread_i_fu_161_p2() {
    i_fu_161_p2 = (!ap_phi_mux_i_0_phi_fu_136_p4.read().is_01() || !ap_const_lv3_1.is_01())? sc_lv<3>(): (sc_biguint<3>(ap_phi_mux_i_0_phi_fu_136_p4.read()) + sc_biguint<3>(ap_const_lv3_1));
}

void load_bias_scale::thread_icmp_ln65_fu_156_p2() {
    icmp_ln65_fu_156_p2 = (!ap_phi_mux_i_0_phi_fu_136_p4.read().is_01() || !TO_r.read().is_01())? sc_lv<1>(): sc_lv<1>(ap_phi_mux_i_0_phi_fu_136_p4.read() == TO_r.read());
}

void load_bias_scale::thread_icmp_ln80_fu_240_p2() {
    icmp_ln80_fu_240_p2 = (!ap_phi_mux_i1_0_phi_fu_148_p4.read().is_01() || !TO_r.read().is_01())? sc_lv<1>(): sc_lv<1>(ap_phi_mux_i1_0_phi_fu_148_p4.read() == TO_r.read());
}
...
void load_bias_scale::thread_m_axi_ddr_V_ARADDR() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage1.read()) && 
        ...
        m_axi_ddr_V_ARADDR =  (sc_lv<32>) (zext_ln85_1_fu_272_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage1.read()) && 
                esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln65_reg_321.read()) && 
                esl_seteq<1,1,1>(ap_block_pp0_stage1_11001.read(), ap_const_boolean_0))) {
        m_axi_ddr_V_ARADDR =  (sc_lv<32>) (zext_ln70_fu_188_p1.read());
    } else {
...
void load_bias_scale::thread_scale_address0() {
    scale_address0 =  (sc_lv<2>) (zext_ln90_fu_282_p1.read());
}
...
void load_bias_scale::thread_shl_ln5_fu_171_p3() {
    shl_ln5_fu_171_p3 = esl_concat<2,4>(trunc_ln70_fu_167_p1.read(), ap_const_lv4_0);
}

void load_bias_scale::thread_shl_ln85_1_fu_255_p3() {
    shl_ln85_1_fu_255_p3 = esl_concat<2,4>(trunc_ln85_fu_251_p1.read(), ap_const_lv4_0);
}

void load_bias_scale::thread_shl_ln_fu_224_p3() {
    shl_ln_fu_224_p3 = esl_concat<3,4>(TO_r.read(), ap_const_lv4_0);
}

void load_bias_scale::thread_trunc_ln70_fu_167_p1() {
    trunc_ln70_fu_167_p1 = ap_phi_mux_i_0_phi_fu_136_p4.read().range(2-1, 0);
}

void load_bias_scale::thread_trunc_ln85_fu_251_p1() {
    trunc_ln85_fu_251_p1 = ap_phi_mux_i1_0_phi_fu_148_p4.read().range(2-1, 0);
}

void load_bias_scale::thread_zext_ln70_fu_188_p1() {
    zext_ln70_fu_188_p1 = esl_zext<64,16>(add_ln70_reg_330.read());
}

void load_bias_scale::thread_zext_ln75_1_fu_179_p1() {
    zext_ln75_1_fu_179_p1 = esl_zext<16,6>(shl_ln5_fu_171_p3.read());
}

void load_bias_scale::thread_zext_ln75_fu_198_p1() {
    zext_ln75_fu_198_p1 = esl_zext<64,3>(i_0_reg_132_pp0_iter1_reg.read());
}

void load_bias_scale::thread_zext_ln85_1_fu_272_p1() {
    zext_ln85_1_fu_272_p1 = esl_zext<64,16>(add_ln85_1_reg_435.read());
}

void load_bias_scale::thread_zext_ln85_fu_231_p1() {
    zext_ln85_fu_231_p1 = esl_zext<16,7>(shl_ln_fu_224_p3.read());
}

void load_bias_scale::thread_zext_ln90_1_fu_263_p1() {
    zext_ln90_1_fu_263_p1 = esl_zext<16,6>(shl_ln85_1_fu_255_p3.read());
}

void load_bias_scale::thread_zext_ln90_fu_282_p1() {
    zext_ln90_fu_282_p1 = esl_zext<64,3>(i1_0_reg_144_pp1_iter1_reg.read());
}
...
void load_bias_scale::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln65_fu_156_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0)))) {
                ap_NS_fsm = ap_ST_fsm_pp0_stage1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp0_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln65_fu_156_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_enable_reg_pp0_iter1.read(), ap_const_logic_0))) {
        ...
        case 131072 : 
            ...
            break;
        case 262144 : 
            if ((esl_seteq<1,1,1>(ap_block_pp1_stage0_subdone.read(), ap_const_boolean_0) && !(esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln80_fu_240_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_enable_reg_pp1_iter1.read(), ap_const_logic_0)))) {
                ap_NS_fsm = ap_ST_fsm_pp1_stage1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_enable_reg_pp1_iter0.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_subdone.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(icmp_ln80_fu_240_p2.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_enable_reg_pp1_iter1.read(), ap_const_logic_0))) {
