...
// ==============================================================
#ifndef __conv_layer_outbuf_V_H__
#define __conv_layer_outbuf_V_H__
...
struct conv_layer_outbuf_V_ram : public sc_core::sc_module {
...
sc_core::sc_signal<sc_logic> we1_t1; 
   SC_CTOR(conv_layer_outbuf_V_ram) {
...
conv_layer_outbuf_V_ram* meminst;


SC_CTOR(conv_layer_outbuf_V) {
meminst = new conv_layer_outbuf_V_ram("conv_layer_outbuf_V_ram");
