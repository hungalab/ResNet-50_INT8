...
wire   [8:0] dataflow_in_loop_Con_U0_l_0;
...
wire   [13:0] dataflow_in_loop_Con_U0_outbuf_V_address0;
wire    dataflow_in_loop_Con_U0_outbuf_V_ce0;
wire   [1535:0] dataflow_in_loop_Con_U0_outbuf_V_d0;
wire    dataflow_in_loop_Con_U0_outbuf_V_we0;
wire   [13:0] dataflow_in_loop_Con_U0_outbuf_V_address1;
wire    dataflow_in_loop_Con_U0_outbuf_V_ce1;
wire   [1535:0] dataflow_in_loop_Con_U0_outbuf_V_d1;
wire    dataflow_in_loop_Con_U0_outbuf_V_we1;
...
always @ (*) begin
    if (((ap_start == 1'b0) & (loop_dataflow_output_count == 17'd0) & (dataflow_in_loop_Con_U0_ap_idle == 1'b1))) begin
        ap_idle = 1'b1;
    end else begin
        ap_idle = 1'b0;
    end
...
assign bound_minus_1 = (mul_ln189_2 - 17'd1);
...
assign outbuf_V_address0 = dataflow_in_loop_Con_U0_outbuf_V_address0;

assign outbuf_V_address1 = dataflow_in_loop_Con_U0_outbuf_V_address1;

assign outbuf_V_ce0 = dataflow_in_loop_Con_U0_outbuf_V_ce0;

assign outbuf_V_ce1 = dataflow_in_loop_Con_U0_outbuf_V_ce1;

assign outbuf_V_d0 = 1536'd0;

assign outbuf_V_d1 = dataflow_in_loop_Con_U0_outbuf_V_d1;

assign outbuf_V_we0 = 1'b0;

assign outbuf_V_we1 = dataflow_in_loop_Con_U0_outbuf_V_we1;
