...
entity conv_layer_outbuf_V_ram is 
    generic(
...
architecture rtl of conv_layer_outbuf_V_ram is 
...
architecture arch of conv_layer_outbuf_V is
    component conv_layer_outbuf_V_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    conv_layer_outbuf_V_ram_U :  component conv_layer_outbuf_V_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
