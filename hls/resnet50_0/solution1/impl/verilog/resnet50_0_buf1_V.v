...
// ==============================================================
`timescale 1 ns / 1 ps
module resnet50_0_buf1_V_ram (addr0, ce0, q0, addr1, ce1, d1, we1, q1,  clk);
...
initial begin
    $readmemh("./resnet50_0_buf1_V_ram.dat", ram);
end
...
resnet50_0_buf1_V_ram resnet50_0_buf1_V_ram_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
