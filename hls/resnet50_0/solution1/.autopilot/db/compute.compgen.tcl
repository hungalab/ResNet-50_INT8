...
set id 653
set name resnet50_0_udiv_9ns_4ns_9_13_seq_1
...
set id 654
set name resnet50_0_udiv_9ns_2ns_9_13_seq_1
set corename simcore_udiv_seq
set op udiv
set stage_num 13
set max_latency -1
...
set id 655
set name resnet50_0_udiv_9ns_8ns_9_13_seq_1
set corename simcore_udiv_seq
set op udiv
set stage_num 13
set max_latency -1
...
set id 656
set name resnet50_0_urem_9ns_4ns_5_13_seq_1
...
set id 657
set name resnet50_0_urem_9ns_2ns_3_13_seq_1
set corename simcore_urem_seq
set op urem
set stage_num 13
set max_latency -1
...
set id 659
set name resnet50_0_mac_muladd_14s_4ns_5ns_18_1_1
...
set out_width 18
set exp i0*i1+i2
set arg_lists {i0 {14 1 +} i1 {4 0 +} m {18 1 +} i2 {5 0 +} p {18 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 660
set name resnet50_0_mac_muladd_13s_3ns_9ns_16_1_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {13 1 +} i1 {3 0 +} m {16 1 +} i2 {9 0 +} p {16 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
set id 661
set name resnet50_0_mul_mul_27s_8ns_35_1_1
...
set out_width 35
set exp i0*i1
set arg_lists {i0 {27 1 +} i1 {8 0 +} p {35 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
set id 663
set name resnet50_0_mac_muladd_27s_8ns_35s_36_1_1
set corename simcore_mac
set op mac
set stage_num 1
set max_latency -1
...
set out_width 36
set exp i0*i1+i2
set arg_lists {i0 {27 1 +} i1 {8 0 +} m {35 1 +} i2 {35 1 +} p {36 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outbuf_V \
    op interface \
    ports { outbuf_V_address0 { O 14 vector } outbuf_V_ce0 { O 1 bit } outbuf_V_q0 { I 1536 vector } outbuf_V_address1 { O 14 vector } outbuf_V_ce1 { O 1 bit } outbuf_V_we1 { O 1 bit } outbuf_V_d1 { O 1536 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_TO_r \
    op interface \
    ports { TO_r_dout { I 3 vector } TO_r_empty_n { I 1 bit } TO_r_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_TI \
    op interface \
    ports { TI_dout { I 4 vector } TI_empty_n { I 1 bit } TI_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_l_0 \
    op interface \
    ports { l_0_dout { I 9 vector } l_0_empty_n { I 1 bit } l_0_read { O 1 bit } } \
} "
}
