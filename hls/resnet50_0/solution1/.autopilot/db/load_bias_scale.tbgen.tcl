...
set C_modelArgList {
	{ bias int 2048 regular {array 4 { 0 } 0 1 }  }
	{ scale int 2048 regular {array 4 { 0 } 0 1 }  }
	{ ddr_V int 128 regular {axi_master 0}  }
	{ TO_r int 3 regular  }
	{ offset int 16 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bias", "interface" : "memory", "bitwidth" : 2048, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "offset", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ offset sc_in sc_lv 16 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "offset", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "offset", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "52", "Max" : "148"}
	, {"Name" : "Interval", "Min" : "52", "Max" : "148"}
]}
...
set Spec2ImplPortList { 
	bias { ap_memory {  { bias_address0 mem_address 1 2 }  { bias_ce0 mem_ce 1 1 }  { bias_we0 mem_we 1 1 }  { bias_d0 mem_din 1 2048 } } }
	scale { ap_memory {  { scale_address0 mem_address 1 2 }  { scale_ce0 mem_ce 1 1 }  { scale_we0 mem_we 1 1 }  { scale_d0 mem_din 1 2048 } } }
	...
	offset { ap_none {  { offset in_data 0 16 } } }
}
