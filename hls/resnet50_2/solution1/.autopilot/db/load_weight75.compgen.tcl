...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_l_0_out \
    op interface \
    ports { l_0_out_din { O 14 vector } l_0_out_full_n { I 1 bit } l_0_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { OSIZE_out_din { O 4 vector } OSIZE_out_full_n { I 1 bit } OSIZE_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_TO_out \
    op interface \
    ports { TO_out_din { O 6 vector } TO_out_full_n { I 1 bit } TO_out_write { O 1 bit } } \
} "
}
