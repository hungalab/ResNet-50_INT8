...
set id 3158
set name resnet50_2_fadd_32ns_32ns_32_4_full_dsp_1
...
set id 3190
set name resnet50_2_fmul_32ns_32ns_32_2_max_dsp_1
...
set id 3222
set name resnet50_2_sitofp_32s_32_3_1
...
set id 3254
set name resnet50_2_fcmp_32ns_32ns_1_2_1
...
set id 3286
set name resnet50_2_mac_muladd_6ns_8ns_6ns_13_1_1
...
set out_width 13
set exp i0*i1+i2
set arg_lists {i0 {6 0 +} i1 {8 0 +} m {13 0 +} i2 {6 0 +} p {13 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outbuf_V_2 \
    op interface \
    ports { outbuf_V_2_address0 { O 12 vector } outbuf_V_2_ce0 { O 1 bit } outbuf_V_2_q0 { I 1536 vector } outbuf_V_2_address1 { O 12 vector } outbuf_V_2_ce1 { O 1 bit } outbuf_V_2_we1 { O 1 bit } outbuf_V_2_d1 { O 1536 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_V \
    op interface \
    ports { output_V_address1 { O 13 vector } output_V_ce1 { O 1 bit } output_V_we1 { O 1 bit } output_V_d1 { O 288 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename bias \
    op interface \
    ports { bias_address0 { O 5 vector } bias_ce0 { O 1 bit } bias_q0 { I 2048 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename scale \
    op interface \
    ports { scale_address0 { O 5 vector } scale_ce0 { O 1 bit } scale_q0 { I 2048 vector } } \
} "
} else {
