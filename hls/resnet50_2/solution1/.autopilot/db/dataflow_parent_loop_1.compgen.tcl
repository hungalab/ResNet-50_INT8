...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename input_V \
    op interface \
    ports { input_V_address0 { O 13 vector } input_V_ce0 { O 1 bit } input_V_d0 { O 288 vector } input_V_q0 { I 288 vector } input_V_we0 { O 1 bit } input_V_address1 { O 13 vector } input_V_ce1 { O 1 bit } input_V_d1 { O 288 vector } input_V_q1 { I 288 vector } input_V_we1 { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outbuf_V_4 \
    op interface \
    ports { outbuf_V_4_address0 { O 12 vector } outbuf_V_4_ce0 { O 1 bit } outbuf_V_4_d0 { O 1536 vector } outbuf_V_4_q0 { I 1536 vector } outbuf_V_4_we0 { O 1 bit } outbuf_V_4_address1 { O 12 vector } outbuf_V_4_ce1 { O 1 bit } outbuf_V_4_d1 { O 1536 vector } outbuf_V_4_q1 { I 1536 vector } outbuf_V_4_we1 { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_OFFSET \
    op interface \
    ports { OFFSET { I 24 vector } OFFSET_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_OSIZE \
    op interface \
    ports { OSIZE { I 4 vector } OSIZE_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_TO_r \
    op interface \
    ports { TO_r { I 6 vector } TO_r_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_TI \
    op interface \
    ports { TI { I 6 vector } TI_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_S \
    op interface \
    ports { S { I 2 vector } S_ap_vld { I 1 bit } } \
} "
}
