...
void load_weight75::thread_OFFSET_cast_fu_418_p1() {
    OFFSET_cast_fu_418_p1 = esl_zext<25,24>(OFFSET.read());
}
...
void load_weight75::thread_add_ln204_fu_430_p2() {
    add_ln204_fu_430_p2 = (!shl_ln_fu_422_p3.read().is_01() || !OFFSET_cast_fu_418_p1.read().is_01())? sc_lv<25>(): (sc_biguint<25>(shl_ln_fu_422_p3.read()) + sc_biguint<25>(OFFSET_cast_fu_418_p1.read()));
}
