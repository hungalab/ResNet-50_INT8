...
architecture behav of dataflow_parent_loop_1 is 
    ...
    signal dataflow_in_loop_Con_U0_l_0 : STD_LOGIC_VECTOR (13 downto 0);
    signal dataflow_in_loop_Con_U0_input_V_address0 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal dataflow_in_loop_Con_U0_input_V_address1 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal dataflow_in_loop_Con_U0_outbuf_V_4_address0 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal dataflow_in_loop_Con_U0_outbuf_V_4_address1 : STD_LOGIC_VECTOR (11 downto 0);
    ...
    signal loop_dataflow_input_count : STD_LOGIC_VECTOR (21 downto 0) := "0000000000000000000000";
    signal loop_dataflow_output_count : STD_LOGIC_VECTOR (21 downto 0) := "0000000000000000000000";
    signal bound_minus_1 : STD_LOGIC_VECTOR (21 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                loop_dataflow_input_count <= ap_const_lv22_0;
            else
                if ((not((loop_dataflow_input_count = bound_minus_1)) and (ap_start = ap_const_logic_1) and (dataflow_in_loop_Con_U0_ap_ready = ap_const_logic_1))) then 
                    loop_dataflow_input_count <= std_logic_vector(unsigned(loop_dataflow_input_count) + unsigned(ap_const_lv22_1));
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                loop_dataflow_output_count <= ap_const_lv22_0;
            else
                if ((not((loop_dataflow_output_count = bound_minus_1)) and (dataflow_in_loop_Con_U0_ap_continue = ap_const_logic_1) and (dataflow_in_loop_Con_U0_ap_done = ap_const_logic_1))) then 
                    loop_dataflow_output_count <= std_logic_vector(unsigned(loop_dataflow_output_count) + unsigned(ap_const_lv22_1));
    ...
    begin
        if (((ap_start = ap_const_logic_0) and (loop_dataflow_output_count = ap_const_lv22_0) and (dataflow_in_loop_Con_U0_ap_idle = ap_const_logic_1))) then 
    ...
    bound_minus_1 <= std_logic_vector(unsigned(mul_ln189_2) - unsigned(ap_const_lv22_1));
    ...
    dataflow_in_loop_Con_U0_l_0 <= loop_dataflow_input_count(14 - 1 downto 0);
