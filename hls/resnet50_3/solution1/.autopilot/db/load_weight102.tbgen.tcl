...
set C_modelName {load_weight102}
...
set C_modelArgList {
	...
	{ P int 1 regular  }
	{ K int 2 regular  }
	{ l_0_out int 15 regular {fifo 1}  }
	{ TO_out int 6 regular {fifo 1}  }
	{ TI_out int 7 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ddr_V", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "l_0_out", "interface" : "fifo", "bitwidth" : 15, "direction" : "WRITEONLY"} , 
 	{ "Name" : "TO_out", "interface" : "fifo", "bitwidth" : 6, "direction" : "WRITEONLY"} , 
 	{ "Name" : "TI_out", "interface" : "fifo", "bitwidth" : 7, "direction" : "WRITEONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "l_0_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":15, "type": "signal", "bundle":{"name": "l_0_out", "role": "din" }} , 
 	...
 	{ "name": "TI_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "TI_out", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	l_0_out { ap_fifo {  { l_0_out_din fifo_data 1 15 }  { l_0_out_full_n fifo_status 0 1 }  { l_0_out_write fifo_update 1 1 } } }
	TO_out { ap_fifo {  { TO_out_din fifo_data 1 6 }  { TO_out_full_n fifo_status 0 1 }  { TO_out_write fifo_update 1 1 } } }
	TI_out { ap_fifo {  { TI_out_din fifo_data 1 7 }  { TI_out_full_n fifo_status 0 1 }  { TI_out_write fifo_update 1 1 } } }
