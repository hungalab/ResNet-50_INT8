...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename weight_V \
    op interface \
    ports { weight_V_address0 { O 4 vector } weight_V_ce0 { O 1 bit } weight_V_we0 { O 1 bit } weight_V_d0 { O 1024 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_och_0_out \
    op interface \
    ports { och_0_out_din { O 10 vector } och_0_out_full_n { I 1 bit } och_0_out_write { O 1 bit } } \
} "
}
