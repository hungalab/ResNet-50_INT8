...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_l_0_out \
    op interface \
    ports { l_0_out_din { O 15 vector } l_0_out_full_n { I 1 bit } l_0_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_TI_out \
    op interface \
    ports { TI_out_din { O 7 vector } TI_out_full_n { I 1 bit } TI_out_write { O 1 bit } } \
} "
}
