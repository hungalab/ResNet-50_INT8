...
set id 3519
set name resnet50_3_fptrunc_64ns_32_2_1
...
set id 3520
set name resnet50_3_ddiv_64ns_64ns_64_17_1
...
set id 3521
set name resnet50_3_sitodp_32s_64_4_1
...
set ID 3525
set hasByteEnable 0
set MemName average_pool_buf_V
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename output_V \
    op interface \
    ports { output_V_address1 { O 4 vector } output_V_ce1 { O 1 bit } output_V_we1 { O 128 vector } output_V_d1 { O 1024 vector } } \
} "
} else {
