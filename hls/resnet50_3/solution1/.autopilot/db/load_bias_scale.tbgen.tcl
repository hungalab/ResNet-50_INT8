set moduleName load_bias_scale
set isTopModule 0
...
set C_modelName {load_bias_scale}
set C_modelType { void 0 }
set C_modelArgList {
	{ bias int 2048 regular {array 32 { 0 } 0 1 }  }
	{ scale int 2048 regular {array 32 { 0 } 0 1 }  }
	{ ddr_V int 128 regular {axi_master 0}  }
	{ TO_r int 6 regular  }
	{ offset int 22 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "bias", "interface" : "memory", "bitwidth" : 2048, "direction" : "WRITEONLY"} , 
 	{ "Name" : "scale", "interface" : "memory", "bitwidth" : 2048, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ bias_address0 sc_out sc_lv 5 signal 0 } 
	{ bias_ce0 sc_out sc_logic 1 signal 0 } 
	{ bias_we0 sc_out sc_logic 1 signal 0 } 
	{ bias_d0 sc_out sc_lv 2048 signal 0 } 
	{ scale_address0 sc_out sc_lv 5 signal 1 } 
	{ scale_ce0 sc_out sc_logic 1 signal 1 } 
	{ scale_we0 sc_out sc_logic 1 signal 1 } 
	{ scale_d0 sc_out sc_lv 2048 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bias_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":2048, "type": "signal", "bundle":{"name": "bias", "role": "d0" }} , 
 	...
 	{ "name": "scale_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":2048, "type": "signal", "bundle":{"name": "scale", "role": "d0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "276", "Max" : "1044"}
	, {"Name" : "Interval", "Min" : "276", "Max" : "1044"}
]}
...
set Spec2ImplPortList { 
	bias { ap_memory {  { bias_address0 mem_address 1 5 }  { bias_ce0 mem_ce 1 1 }  { bias_we0 mem_we 1 1 }  { bias_d0 mem_din 1 2048 } } }
	scale { ap_memory {  { scale_address0 mem_address 1 5 }  { scale_ce0 mem_ce 1 1 }  { scale_we0 mem_we 1 1 }  { scale_d0 mem_din 1 2048 } } }
