...
set id 3140
set name resnet50_3_fadd_32ns_32ns_32_4_full_dsp_1
...
set id 3172
set name resnet50_3_fmul_32ns_32ns_32_2_max_dsp_1
...
set id 3204
set name resnet50_3_sitofp_32s_32_3_1
...
set id 3236
set name resnet50_3_fcmp_32ns_32ns_1_2_1
...
set id 3268
set name resnet50_3_mac_muladd_7s_6ns_6ns_12_1_1
...
set out_width 12
set exp i0*i1+i2
set arg_lists {i0 {7 1 +} i1 {6 0 +} m {12 1 +} i2 {6 0 +} p {12 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outbuf_V_2 \
    op interface \
    ports { outbuf_V_2_address0 { O 11 vector } outbuf_V_2_ce0 { O 1 bit } outbuf_V_2_q0 { I 1536 vector } outbuf_V_2_address1 { O 11 vector } outbuf_V_2_ce1 { O 1 bit } outbuf_V_2_we1 { O 1 bit } outbuf_V_2_d1 { O 1536 vector } } \
} "
} else {
