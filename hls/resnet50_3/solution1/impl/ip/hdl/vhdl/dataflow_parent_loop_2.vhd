...
entity dataflow_parent_loop_2 is
port (
...
architecture behav of dataflow_parent_loop_2 is 
    ...
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWVALID : STD_LOGIC;
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_WVALID : STD_LOGIC;
    signal dataflow_in_loop_U0_m_axi_ddr_V_WDATA : STD_LOGIC_VECTOR (127 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_WSTRB : STD_LOGIC_VECTOR (15 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_WLAST : STD_LOGIC;
    signal dataflow_in_loop_U0_m_axi_ddr_V_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARVALID : STD_LOGIC;
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop_U0_m_axi_ddr_V_RREADY : STD_LOGIC;
    signal dataflow_in_loop_U0_m_axi_ddr_V_BREADY : STD_LOGIC;
    signal dataflow_in_loop_U0_input_V_address0 : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_input_V_ce0 : STD_LOGIC;
    signal dataflow_in_loop_U0_input_V_d0 : STD_LOGIC_VECTOR (1023 downto 0);
    signal dataflow_in_loop_U0_input_V_we0 : STD_LOGIC;
    signal dataflow_in_loop_U0_input_V_address1 : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop_U0_input_V_ce1 : STD_LOGIC;
    signal dataflow_in_loop_U0_input_V_d1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal dataflow_in_loop_U0_input_V_we1 : STD_LOGIC;
    signal dataflow_in_loop_U0_bias_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal dataflow_in_loop_U0_bias_ce0 : STD_LOGIC;
    signal dataflow_in_loop_U0_bias_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_bias_we0 : STD_LOGIC;
    signal dataflow_in_loop_U0_bias_address1 : STD_LOGIC_VECTOR (9 downto 0);
    signal dataflow_in_loop_U0_bias_ce1 : STD_LOGIC;
    signal dataflow_in_loop_U0_bias_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_bias_we1 : STD_LOGIC;
    signal dataflow_in_loop_U0_scale_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal dataflow_in_loop_U0_scale_ce0 : STD_LOGIC;
    signal dataflow_in_loop_U0_scale_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_scale_we0 : STD_LOGIC;
    signal dataflow_in_loop_U0_scale_address1 : STD_LOGIC_VECTOR (9 downto 0);
    signal dataflow_in_loop_U0_scale_ce1 : STD_LOGIC;
    signal dataflow_in_loop_U0_scale_d1 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_scale_we1 : STD_LOGIC;
    signal dataflow_in_loop_U0_output_r_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal dataflow_in_loop_U0_output_r_ce0 : STD_LOGIC;
    signal dataflow_in_loop_U0_output_r_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop_U0_output_r_we0 : STD_LOGIC;
...
begin
    ...
    port map (
        ...
        input_V_q1 => ap_const_lv1024_lc_1,
        ...
        output_r_q0 => ap_const_lv32_0,
        output_r_we0 => dataflow_in_loop_U0_output_r_we0,
        och_0_ap_vld => ap_const_logic_0,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not((loop_dataflow_input_count = bound_minus_1)) and (ap_start = ap_const_logic_1) and (dataflow_in_loop_U0_ap_ready = ap_const_logic_1))) then 
                    loop_dataflow_input_count <= std_logic_vector(unsigned(loop_dataflow_input_count) + unsigned(ap_const_lv10_1));
                elsif (((loop_dataflow_input_count = bound_minus_1) and (ap_start = ap_const_logic_1) and (dataflow_in_loop_U0_ap_ready = ap_const_logic_1))) then 
                    loop_dataflow_input_count <= ap_const_lv10_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((not((loop_dataflow_output_count = bound_minus_1)) and (dataflow_in_loop_U0_ap_continue = ap_const_logic_1) and (dataflow_in_loop_U0_ap_done = ap_const_logic_1))) then 
                    loop_dataflow_output_count <= std_logic_vector(unsigned(loop_dataflow_output_count) + unsigned(ap_const_lv10_1));
                elsif (((loop_dataflow_output_count = bound_minus_1) and (dataflow_in_loop_U0_ap_continue = ap_const_logic_1) and (dataflow_in_loop_U0_ap_done = ap_const_logic_1))) then 
                    loop_dataflow_output_count <= ap_const_lv10_0;
                end if; 
            end if;
        end if;
    ...
    ap_done_assign_proc : process(dataflow_in_loop_U0_ap_done, loop_dataflow_output_count, bound_minus_1)
    begin
        if (((loop_dataflow_output_count = bound_minus_1) and (dataflow_in_loop_U0_ap_done = ap_const_logic_1))) then 
    ...
    ap_idle_assign_proc : process(dataflow_in_loop_U0_ap_idle, ap_start, loop_dataflow_output_count)
    begin
        if (((ap_start = ap_const_logic_0) and (dataflow_in_loop_U0_ap_idle = ap_const_logic_1) and (loop_dataflow_output_count = ap_const_lv10_0))) then 
    ...
    ap_ready_assign_proc : process(dataflow_in_loop_U0_ap_ready, ap_start, loop_dataflow_input_count, bound_minus_1)
    begin
        if (((loop_dataflow_input_count = bound_minus_1) and (ap_start = ap_const_logic_1) and (dataflow_in_loop_U0_ap_ready = ap_const_logic_1))) then 
    ...
    bound_minus_1 <= std_logic_vector(unsigned(ap_const_lv10_3E8) - unsigned(ap_const_lv10_1));

    dataflow_in_loop_U0_ap_continue_assign_proc : process(ap_continue, loop_dataflow_output_count, bound_minus_1)
    begin
    ...
    dataflow_in_loop_U0_ap_start <= ap_start;
