...
entity resnet50_3_AXILiteS_s_axi is
generic (
...
end entity resnet50_3_AXILiteS_s_axi;
...
architecture behave of resnet50_3_AXILiteS_s_axi is
    ...
    constant ADDR_OUTPUT_R_BASE : INTEGER := 16#1000#;
    constant ADDR_OUTPUT_R_HIGH : INTEGER := 16#1fff#;
    ...
    -- memory signals
    signal int_output_r_address0 : UNSIGNED(9 downto 0);
    ...
    signal int_output_r_address1 : UNSIGNED(9 downto 0);
    ...
    component resnet50_3_AXILiteS_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component resnet50_3_AXILiteS_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_output_r
int_output_r : resnet50_3_AXILiteS_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 1000,
     AWIDTH   => log2(1000))
...
-- ----------------------- Memory logic ------------------
    ...
    int_output_r_address1 <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
...
entity resnet50_3_AXILiteS_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity resnet50_3_AXILiteS_s_axi_ram;

architecture behave of resnet50_3_AXILiteS_s_axi_ram is
