...
// ==============================================================
`timescale 1ns/1ps
module resnet50_3_AXILiteS_s_axi
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    input  wire [9:0]                    output_r_address0,
...
localparam
    ...
    ADDR_IER           = 13'h0008,
    ADDR_ISR           = 13'h000c,
    ADDR_OUTPUT_R_BASE = 13'h1000,
    ADDR_OUTPUT_R_HIGH = 13'h1fff,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
...
assign RVALID  = (rstate == RDDATA) & !int_output_r_read;
...
assign int_output_r_address1 = ar_hs? raddr[11:2] : waddr[11:2];
...
module resnet50_3_AXILiteS_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
